...
namespace MovieReviewsApp.Controllers
{
    public class ReviewController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieName,Message")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MovieName,Message")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
